...
class User extends (0, _reactDefault.default).Component {
    ...
    componentDidMount() {
        fetch("https://api.github.com/users/Rohitsaini0444").then((response)=>response.json()).then((data)=>{
            console.log(data);
            this.setState({
                userInfo: {
                    name: data.name,
                ...
                /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
                    children: [
                        ...
                        /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)((0, _userContextDefault.default).Consumer, {
                            children: (context)=>context.loggedInUser
                        }, void 0, false, {
...
},{"react/jsx-dev-runtime":"dVPUn","react":"jMk1U","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"7h6Pi","../../utils/userContext":"ddOyY"}]},["1aWES"], null, "parcelRequire5906", {})
